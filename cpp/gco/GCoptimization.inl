/////////////////////////////////////////////////////////////////////
// Template definitions for GCoptimizationT<>; included by GCoptimization.h.
// (The non-template pieces -- timer and GCException -- are in GCoptimization.cpp.)
/////////////////////////////////////////////////////////////////////
#ifndef __GCOPTIMIZATION_INL__
#define __GCOPTIMIZATION_INL__
...
// checkInterrupt() polls this; define GCO_INTERRUPT_FN to the name of a
// 'bool f()' that reports whether the caller wants to abort (e.g. Ctrl-C).
#ifdef GCO_INTERRUPT_FN
extern "C" bool GCO_INTERRUPT_FN();
static inline bool gcoInterruptPending() { return GCO_INTERRUPT_FN(); }
#else
static inline bool gcoInterruptPending() { return false; }
#endif
...
GCoptimizationT<TTerm>::GCoptimizationT(SiteID nSites, LabelID nLabels) 
...
, m_queryActiveSitesExpansion(&GCoptimizationT<TTerm>::queryActiveSitesExpansion<DataCostFnFromArray>)
...
, m_solveSpecialCases(&GCoptimizationT<TTerm>::solveSpecialCases<DataCostFnFromArray>)
...
template <typename TTerm>
GCoptimizationT<TTerm>::~GCoptimizationT()
{
	delete [] m_labelTable;
...
template <typename TTerm>
typename GCoptimizationT<TTerm>::SiteID GCoptimizationT<TTerm>::queryActiveSitesExpansionSparse(LabelID alpha_label,SiteID *activeSites)
{
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setupDataCostsExpansionSparse(SiteID size,LabelID alpha_label,EnergyT *e,SiteID *activeSites)
{
	DataCostFnSparse* dc = (DataCostFnSparse*)m_datacostFn;
	typename DataCostFnSparse::iterator dciter = dc->begin(alpha_label);
...
template <typename TTerm>
void GCoptimizationT<TTerm>::applyNewLabelingSparse(EnergyT *e,SiteID *activeSites,SiteID size,LabelID alpha_label)
{
	DataCostFnSparse* dc = (DataCostFnSparse*)m_datacostFn;
	typename DataCostFnSparse::iterator dciter = dc->begin(alpha_label);
	for ( SiteID i = 0; i < size; i++ )
...
void GCoptimizationT<TTerm>::specializeDataCostFunctor(const UserFunctor f) {
	...
	m_datacostFnDelete          = &GCoptimizationT<TTerm>::deleteFunctor<UserFunctor>;
	m_queryActiveSitesExpansion = &GCoptimizationT<TTerm>::queryActiveSitesExpansion<UserFunctor>;
	m_setupDataCostsExpansion   = &GCoptimizationT<TTerm>::setupDataCostsExpansion<UserFunctor>;
	m_setupDataCostsSwap        = &GCoptimizationT<TTerm>::setupDataCostsSwap<UserFunctor>;
	m_applyNewLabeling          = &GCoptimizationT<TTerm>::applyNewLabeling<UserFunctor>;
	m_updateLabelingDataCosts   = &GCoptimizationT<TTerm>::updateLabelingDataCosts<UserFunctor>;
	m_solveSpecialCases         = &GCoptimizationT<TTerm>::solveSpecialCases<UserFunctor>;
}

template <typename TTerm>
template <typename UserFunctor>
void GCoptimizationT<TTerm>::specializeSmoothCostFunctor(const UserFunctor f) {
	...
	m_smoothcostFnDelete        = &GCoptimizationT<TTerm>::deleteFunctor<UserFunctor>;
	m_giveSmoothEnergyInternal  = &GCoptimizationT<TTerm>::giveSmoothEnergyInternal<UserFunctor>;
	m_setupSmoothCostsExpansion = &GCoptimizationT<TTerm>::setupSmoothCostsExpansion<UserFunctor>;
	m_setupSmoothCostsSwap      = &GCoptimizationT<TTerm>::setupSmoothCostsSwap<UserFunctor>;
}
...
typename GCoptimizationT<TTerm>::EnergyType GCoptimizationT<TTerm>::giveSmoothEnergyInternal()
{
...
template <typename TTerm>
OLGA_INLINE void GCoptimizationT<TTerm>::addterm1_checked(EnergyT* e, VarID i, EnergyTermType e0, EnergyTermType e1)
{
	if ( e0 > maxEnergyTerm() || e1 > maxEnergyTerm() )
		handleError("Data cost term was larger than the maximum energy term; danger of integer overflow.");
	m_beforeExpansionEnergy += e1;
	e->add_term1(i,e0,e1);
}

template <typename TTerm>
OLGA_INLINE void GCoptimizationT<TTerm>::addterm1_checked(EnergyT* e, VarID i, EnergyTermType e0, EnergyTermType e1, EnergyTermType w)
{
	if ( e0 > maxEnergyTerm() || e1 > maxEnergyTerm() )
		handleError("Smooth cost term was larger than the maximum energy term; danger of integer overflow.");
	if ( w > maxEnergyTerm() )
		handleError("Smoothness weight was larger than the maximum energy term; danger of integer overflow.");
	m_beforeExpansionEnergy += e1*w;
	e->add_term1(i,e0*w,e1*w);
}

template <typename TTerm>
OLGA_INLINE void GCoptimizationT<TTerm>::addterm2_checked(EnergyT* e, VarID i, VarID j, EnergyTermType e00, EnergyTermType e01, EnergyTermType e10, EnergyTermType e11, EnergyTermType w)
{
	if ( e00 > maxEnergyTerm() || e11 > maxEnergyTerm() || e01 > maxEnergyTerm() || e10 > maxEnergyTerm() )
		handleError("Smooth cost term was larger than the maximum energy term; danger of integer overflow.");
	if ( w > maxEnergyTerm() )
		handleError("Smoothness weight was larger than the maximum energy term; danger of integer overflow.");
...
typename GCoptimizationT<TTerm>::SiteID GCoptimizationT<TTerm>::queryActiveSitesExpansion(LabelID alpha_label,SiteID *activeSites)
{
	if ( std::is_same<DataCostT,DataCostFnSparse>::value )
		return queryActiveSitesExpansionSparse(alpha_label,activeSites);
	SiteID size = 0;
...
template <typename TTerm>
template <typename DataCostT>
void GCoptimizationT<TTerm>::setupDataCostsExpansion(SiteID size,LabelID alpha_label,EnergyT *e,SiteID *activeSites)
{
	if ( std::is_same<DataCostT,DataCostFnSparse>::value ) {
		setupDataCostsExpansionSparse(size,alpha_label,e,activeSites);
		return;
	}
...
template <typename TTerm>
template <typename SmoothCostT>
void GCoptimizationT<TTerm>::setupSmoothCostsExpansion(SiteID size,LabelID alpha_label,EnergyT *e,SiteID *activeSites)
{
...
template <typename TTerm>
template <typename DataCostT>
void GCoptimizationT<TTerm>::setupDataCostsSwap(SiteID size, LabelID alpha_label, LabelID beta_label,
...
template <typename TTerm>
template <typename SmoothCostT>
void GCoptimizationT<TTerm>::setupSmoothCostsSwap(SiteID size, LabelID alpha_label,LabelID beta_label,
										 EnergyT *e,SiteID *activeSites )
{
	SiteID i,nSite,site,n,nNum,*nPointer;
	EnergyTermType *weights;
...
template <typename TTerm>
template <typename DataCostT>
void GCoptimizationT<TTerm>::applyNewLabeling(EnergyT *e,SiteID *activeSites,SiteID size,LabelID alpha_label)
{
	if ( std::is_same<DataCostT,DataCostFnSparse>::value ) {
		applyNewLabelingSparse(e,activeSites,size,alpha_label);
		return;
	}
	DataCostT* dc = (DataCostT*)m_datacostFn;
	for ( SiteID i = 0; i < size; i++ )
...
template <typename TTerm>
template <typename DataCostT>
void GCoptimizationT<TTerm>::updateLabelingDataCosts()
{
	DataCostT* dc = (DataCostT*)m_datacostFn;
...
template <typename TTerm>
template <typename DataCostT>
bool GCoptimizationT<TTerm>::solveSpecialCases(EnergyType& energy)
{
	finalizeNeighbors();
	...
	if ( dc && !sc && !lc ) {
		...
		for ( SiteID i = 0; i < m_num_sites; ++i ) {
			...
			if ( minCostLabel > maxEnergyTerm() )
				handleError("Data cost was larger than the maximum energy term; danger of integer overflow.");
	...
	if ( !dc && !sc && lc ) {
		...
		LabelID minLabel = 0;
		EnergyType minLabelCost = maxEnergyTerm()*(EnergyType)m_num_labels;
...
template <typename TTerm>
template <typename DataCostT>
typename GCoptimizationT<TTerm>::EnergyType GCoptimizationT<TTerm>::solveGreedy()
{
	...
	try {
		...
		for ( LabelID l = 0; l < m_num_labels; ++l ) {
			...
			for ( LabelCostIter* lci = m_labelcostsByLabel[l]; lci; lci = lci->next )
				e[l] += lci->node->cost;
			iter.start(&l);
			e[l] += (EnergyType)(m_num_sites - iter.feasibleSites()) * maxEnergyTerm(); // pre-add the max term for all infeasible sites
			for (; !iter.done(); ++iter) {
				EnergyTermType dataCost = iter.compute();
				if ( dataCost > maxEnergyTerm() )
					handleError("Data cost was larger than the maximum energy term; danger of integer overflow.");
				e[l] += dataCost;
		...
		delete [] e;
		if ( oldLabeling ) {
			// interrupted while greedy was working on its own copy: put the old one back
			delete [] m_labeling;
			m_labeling = oldLabeling;
			m_labelingInfoDirty = true;
		}
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setDataCost(DataCostFn fn) { 
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setDataCost(DataCostFnExtra fn, void *extraData) { 
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setDataCost(EnergyTermType *dataArray) {
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setDataCost(SiteID s, LabelID l, EnergyTermType e) {
	if ( !m_datacostIndividual )
	{
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setDataCostFunctor(DataCostFunctor* f) {
	if ( m_datacostFnDelete )
		m_datacostFnDelete(m_datacostFn);
	if ( m_datacostIndividual )
	{
	...
	m_datacostFn = f;
	m_datacostFnDelete          = 0;
	m_queryActiveSitesExpansion = &GCoptimizationT<TTerm>::queryActiveSitesExpansion<DataCostFunctor>;
	m_setupDataCostsExpansion   = &GCoptimizationT<TTerm>::setupDataCostsExpansion<DataCostFunctor>;
	m_setupDataCostsSwap        = &GCoptimizationT<TTerm>::setupDataCostsSwap<DataCostFunctor>;
	m_applyNewLabeling          = &GCoptimizationT<TTerm>::applyNewLabeling<DataCostFunctor>;
	m_updateLabelingDataCosts   = &GCoptimizationT<TTerm>::updateLabelingDataCosts<DataCostFunctor>;
	m_solveSpecialCases         = &GCoptimizationT<TTerm>::solveSpecialCases<DataCostFunctor>;
	m_labelingInfoDirty = true;
}
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setDataCost(LabelID l, SparseDataCost *costs, SiteID count)
{
	if ( !m_datacostFn )
		specializeDataCostFunctor(DataCostFnSparse(numSites(),numLabels()));
	else if ( m_queryActiveSitesExpansion != (SiteID (GCoptimizationT<TTerm>::*)(LabelID,SiteID*))&GCoptimizationT<TTerm>::queryActiveSitesExpansion<DataCostFnSparse> )
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setSmoothCost(SmoothCostFn fn) {
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setSmoothCost(SmoothCostFnExtra fn, void* extraData) {
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setSmoothCost(EnergyTermType *smoothArray) {
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setSmoothCost(LabelID l1, LabelID l2, EnergyTermType e){
	if ( !m_smoothcostIndividual )
	{
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setSmoothCostFunctor(SmoothCostFunctor* f) {
	if ( m_smoothcostFnDelete )
		m_smoothcostFnDelete(m_smoothcostFn);
	if ( m_smoothcostIndividual )
	{
	...
	m_smoothcostFn = f;
	m_smoothcostFnDelete        = 0;
	m_giveSmoothEnergyInternal  = &GCoptimizationT<TTerm>::giveSmoothEnergyInternal<SmoothCostFunctor>;
	m_setupSmoothCostsExpansion = &GCoptimizationT<TTerm>::setupSmoothCostsExpansion<SmoothCostFunctor>;
	m_setupSmoothCostsSwap      = &GCoptimizationT<TTerm>::setupSmoothCostsSwap<SmoothCostFunctor>;
}

//-------------------------------------------------------------------

template <typename TTerm>
void GCoptimizationT<TTerm>::setLabelCost(EnergyTermType cost) 
{
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setLabelCost(EnergyTermType *costArray) 
{
	for ( LabelID i = 0; i < m_num_labels; ++i )
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setLabelSubsetCost(LabelID* labels, LabelID numLabels, EnergyTermType cost)
{
	if ( cost < 0 )
		handleError("Label costs must be non-negative.");
	if ( cost > maxEnergyTerm() )
		handleError("Label cost was larger than the maximum energy term; danger of integer overflow.");
...
template <typename TTerm>
void GCoptimizationT<TTerm>::whatLabel(SiteID start, SiteID count, LabelID* labeling)
{
...
template <typename TTerm>
typename GCoptimizationT<TTerm>::EnergyType GCoptimizationT<TTerm>::giveSmoothEnergy()
{
	finalizeNeighbors();
...
template <typename TTerm>
typename GCoptimizationT<TTerm>::EnergyType GCoptimizationT<TTerm>::giveDataEnergy()
{
	updateLabelingInfo();
	EnergyType energy = 0;
	for ( SiteID i = 0; i < m_num_sites; i++ )
...
template <typename TTerm>
typename GCoptimizationT<TTerm>::EnergyType GCoptimizationT<TTerm>::giveLabelEnergy()
{
	updateLabelingInfo();
	EnergyType energy = 0;
	for ( LabelCost* lc = m_labelcostsAll; lc; lc = lc->next)
...
template <typename TTerm>
typename GCoptimizationT<TTerm>::EnergyType GCoptimizationT<TTerm>::compute_energy()
{
...
template <typename TTerm>
void GCoptimizationT<TTerm>::permuteLabelTable()
{
...
template <typename TTerm>
typename GCoptimizationT<TTerm>::EnergyType GCoptimizationT<TTerm>::expansion(int max_num_iterations)
{
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setLabelOrder(bool isRandom)
{
...
template <typename TTerm>
void GCoptimizationT<TTerm>::setLabelOrder(const LabelID* order, LabelID size)
{
...
template <typename TTerm>
void GCoptimizationT<TTerm>::handleError(const char *message)
{
...
template <typename TTerm>
void GCoptimizationT<TTerm>::checkInterrupt()
{
	if ( gcoInterruptPending() )
...
template <typename TTerm>
typename GCoptimizationT<TTerm>::EnergyType GCoptimizationT<TTerm>::setupLabelCostsExpansion(SiteID size,LabelID alpha_label,EnergyT *e,SiteID *activeSites)
{
	...
	if ( m_queryActiveSitesExpansion == (SiteID (GCoptimizationT<TTerm>::*)(LabelID,SiteID*))&GCoptimizationT<TTerm>::queryActiveSitesExpansion<DataCostFnSparse> )
	{
...
//-------------------------------------------------------------------
template <typename TTerm>
void GCoptimizationT<TTerm>::updateLabelingInfo(bool updateCounts, bool updateActive, bool updateCosts)
{
...
//
template <typename TTerm>
bool GCoptimizationT<TTerm>::alpha_expansion(LabelID alpha_label)
{
	if (alpha_label < 0)
	...
	{
		// An interrupt/error must leave the object reusable: m_lookupSiteVar has to
		// be all -1s again, or the next move would build edges to stale variables.
		for ( SiteID i = 0; i < size; i++ )
			m_lookupSiteVar[activeSites[i]] = -1;
		delete [] activeSites;
		throw;
	}
	delete [] activeSites;
...
template <typename TTerm>
typename GCoptimizationT<TTerm>::EnergyType GCoptimizationT<TTerm>::oneExpansionIteration()
{
	permuteLabelTable();
	m_stepsThisCycle = 0;
...
template <typename TTerm>
typename GCoptimizationT<TTerm>::EnergyType GCoptimizationT<TTerm>::swap(int max_num_iterations)
{
	EnergyType new_energy,old_energy;
	if ( (this->*m_solveSpecialCases)(new_energy) )
		return new_energy;
...
template <typename TTerm>
typename GCoptimizationT<TTerm>::EnergyType GCoptimizationT<TTerm>::oneSwapIteration()
{
	LabelID next,next1;
	permuteLabelTable();
	m_stepsThisCycle = 0;
...
template <typename TTerm>
void GCoptimizationT<TTerm>::alpha_beta_swap(LabelID alpha_label, LabelID beta_label)
{
	...
	{
		for ( SiteID i = 0; i < size; i++ )   // see alpha_expansion
			m_lookupSiteVar[activeSites[i]] = -1;
		delete [] activeSites;
		throw;
	}
...
template <typename TTerm>
GCoptimizationGridGraphT<TTerm>::GCoptimizationGridGraphT(SiteID width, SiteID height,LabelID num_labels)
						: Base(width*height,num_labels)
{
...
template <typename TTerm>
GCoptimizationGridGraphT<TTerm>::~GCoptimizationGridGraphT()
{
...
template <typename TTerm>
void GCoptimizationGridGraphT<TTerm>::setupNeighbData(SiteID startY,SiteID endY,SiteID startX,
...
template <typename TTerm>
void GCoptimizationGridGraphT<TTerm>::finalizeNeighbors()
{
}
...
template <typename TTerm>
void GCoptimizationGridGraphT<TTerm>::setSmoothCostVH(EnergyTermType *smoothArray, EnergyTermType *vCosts, EnergyTermType *hCosts)
{
	this->setSmoothCost(smoothArray);
	m_weightedGraph = 1;
...
template <typename TTerm>
void GCoptimizationGridGraphT<TTerm>::giveNeighborInfo(SiteID site, SiteID *numSites, SiteID **neighbors, EnergyTermType **weights)
{
...
template <typename TTerm>
void GCoptimizationGridGraphT<TTerm>::computeNeighborWeights(EnergyTermType *vCosts,EnergyTermType *hCosts)
{
	SiteID i,n,nSite;
...
template <typename TTerm>
GCoptimizationGeneralGraphT<TTerm>::GCoptimizationGeneralGraphT(SiteID num_sites,LabelID num_labels): Base(num_sites,num_labels)
{
...
template <typename TTerm>
GCoptimizationGeneralGraphT<TTerm>::~GCoptimizationGeneralGraphT()
{
...
template <typename TTerm>
void GCoptimizationGeneralGraphT<TTerm>::finalizeNeighbors()
{
...
template <typename TTerm>
void GCoptimizationGeneralGraphT<TTerm>::giveNeighborInfo(SiteID site, SiteID *numSites, 
...
template <typename TTerm>
void GCoptimizationGeneralGraphT<TTerm>::setNeighbors(SiteID site1, SiteID site2, EnergyTermType weight)
{
...
template <typename TTerm>
void GCoptimizationGeneralGraphT<TTerm>::setAllNeighbors(SiteID *numNeighbors,SiteID **neighborsIndexes,
...
template <typename TTerm>
void GCoptimizationT<TTerm>::printStatus1(const char* extraMsg)
{
	if ( m_verbosity < 1 )
		return;
	if ( extraMsg )
...
template <typename TTerm>
void GCoptimizationT<TTerm>::printStatus1(int cycle, bool isSwap, gcoclock_t ticks0)
{
	if ( m_verbosity < 1 )
		return;
	...
	if ( m_verbosity == 1 )
	{
		...
		// itself takes time and makes time useless at this level
...
template <typename TTerm>
void GCoptimizationT<TTerm>::printStatus2(int alpha, int beta, int numVars, gcoclock_t ticks0)
{
	if ( m_verbosity < 2 )
		return;
	int microsec = (int)(1000000*(gcoclock() - ticks0) / GCO_CLOCKS_PER_SEC);
	if ( beta >= 0 )
		printf("gco>>   after swap(%d,%d):",alpha,beta);
	else
		printf("gco>>   after expansion(%d):",alpha);
...
template <typename TTerm>
GCoptimizationT<TTerm>::DataCostFnSparse::DataCostFnSparse(SiteID num_sites, LabelID num_labels)
...
template <typename TTerm>
GCoptimizationT<TTerm>::DataCostFnSparse::DataCostFnSparse(const DataCostFnSparse& src)
...
template <typename TTerm>
GCoptimizationT<TTerm>::DataCostFnSparse::~DataCostFnSparse()
{
	if (m_buckets) {
		for (LabelID l = 0; l < m_num_labels; ++l)
...
template <typename TTerm>
void GCoptimizationT<TTerm>::DataCostFnSparse::set(LabelID l, const SparseDataCost* costs, SiteID count)
{
...
template <typename TTerm>
typename GCoptimizationT<TTerm>::EnergyTermType GCoptimizationT<TTerm>::DataCostFnSparse::search(DataCostBucket& b, SiteID s)
{
	...
	return maxEnergyTerm(); // the site belongs to this bucket but with no cost specified
}

template <typename TTerm>
OLGA_INLINE typename GCoptimizationT<TTerm>::EnergyTermType GCoptimizationT<TTerm>::DataCostFnSparse::compute(SiteID s, LabelID l)
{
	DataCostBucket& b = m_buckets[l*m_buckets_per_label + (s >> cLogSitesPerBucket)];
	if (b.begin == b.end)
		return maxEnergyTerm();
	if (b.predict < b.end) {
...
template <typename TTerm>
typename GCoptimizationT<TTerm>::SiteID GCoptimizationT<TTerm>::DataCostFnSparse::queryActiveSitesExpansion(LabelID alpha_label, const LabelID* labeling, SiteID* activeSites)
{
